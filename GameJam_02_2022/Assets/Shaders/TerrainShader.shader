...
Shader "Custom/TerrainShader_02"
{
	Properties
	{
		...
		[NoScaleOffset]_TextureParasite1("TextureParasite", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_1_0_g5 = tex2DNode37.r;
			float temp_output_2_0_g5 = tex2DNode37.b;
			float dotResult3_g5 = dot( temp_output_1_0_g5 , temp_output_2_0_g5 );
			float3 appendResult8_g5 = (float3(temp_output_1_0_g5 , temp_output_2_0_g5 , ( _ScaleNormalRock * sqrt( ( 1.0 - saturate( dotResult3_g5 ) ) ) )));
			float3 NormalRock43 = appendResult8_g5;
			float2 uv_TexCoord3 = i.uv_texcoord * _TillingGrass;
			float4 tex2DNode11 = tex2D( _MaskGrassTexture, uv_TexCoord3 );
			float temp_output_1_0_g6 = tex2DNode11.r;
			float temp_output_2_0_g6 = tex2DNode11.b;
			float dotResult3_g6 = dot( temp_output_1_0_g6 , temp_output_2_0_g6 );
			float3 appendResult8_g6 = (float3(temp_output_1_0_g6 , temp_output_2_0_g6 , ( _ScaleNormalGrass * sqrt( ( 1.0 - saturate( dotResult3_g6 ) ) ) )));
			float3 NormalGrass42 = appendResult8_g6;
			...
			float temp_output_1_0_g4 = tex2DNode52.r;
			float temp_output_2_0_g4 = tex2DNode52.b;
			float dotResult3_g4 = dot( temp_output_1_0_g4 , temp_output_2_0_g4 );
			float3 appendResult8_g4 = (float3(temp_output_1_0_g4 , temp_output_2_0_g4 , ( _ScaleNormalDirt * sqrt( ( 1.0 - saturate( dotResult3_g4 ) ) ) )));
			float3 NormalDirt59 = appendResult8_g4;
			...
			float temp_output_1_0_g7 = tex2DNode65.r;
			float temp_output_2_0_g7 = tex2DNode65.b;
			float dotResult3_g7 = dot( temp_output_1_0_g7 , temp_output_2_0_g7 );
			float3 appendResult8_g7 = (float3(temp_output_1_0_g7 , temp_output_2_0_g7 , ( _ScaleNormalGravel * sqrt( ( 1.0 - saturate( dotResult3_g7 ) ) ) )));
			float3 NormalGravel77 = appendResult8_g7;
			...
			float2 uv_TexCoord140 = i.uv_texcoord * _TillingTextureParasite1;
			float4 ParasiteTexturePattern145 = tex2D( _TextureParasite1, uv_TexCoord140 );
			...
			float AlbedoParasite150 = ( MaxEffectPosition144 * Alpha151 );
			float4 lerpResult155 = lerp( FinalAlbedo21 , ( ParasiteTexturePattern145 * AlbedoParasite150 ) , AlbedoParasite150);
...
/*ASEBEGIN
Version=18917
-244;1030;1920;769;745.7944;-3020.702;1.164054;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;172;186.8812,4625.106;Inherit;False;Property;_SpeedNoiseBorder;SpeedNoiseBorder;26;0;Create;True;0;0;0;False;0;False;1;0.002;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;163;647.1596,4760.838;Inherit;False;Property;_ScaleBorderNoise;ScaleBorderNoise;24;0;Create;True;0;0;0;False;0;False;50;420.78;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;134;-164.2145,4385.541;Inherit;False;Property;_CenterPositionWorld;CenterPosition;4;0;Create;False;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;138;229.5584,4449.531;Inherit;False;Property;_RadiusInfection;RadiusInfection;5;0;Create;False;0;0;0;False;0;False;0;63.90882;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;1209.529,4619.806;Inherit;False;Property;_BorderIntensity;BorderIntensity;25;0;Create;True;0;0;0;False;0;False;1;1.54;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;4;-1603.462,182.3962;Inherit;False;Property;_TillingGrass;TillingGrass;15;0;Create;True;0;0;0;False;0;False;1,1;16,16;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;28;-1649.223,1380.041;Inherit;False;Property;_TillingRock;TillingRock;16;0;Create;True;0;0;0;False;0;False;1,1;16,16;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;7;-1525.603,-575.1351;Inherit;True;Property;_SplatMap;SplatMap;10;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;a08ef57615cfe764fb6bc38911e957bc;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;60;-1653.469,2612.333;Inherit;False;Property;_TillingDirt;TillingDirt;17;0;Create;True;0;0;0;False;0;False;1,1;16,16;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.CommentaryNode;143;-307.4802,5386.607;Inherit;False;1399.364;972.6797;Blend;13;158;155;153;152;154;150;149;146;148;151;147;159;191;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;69;-1657.974,3823.894;Inherit;False;Property;_TillingGravel;TillingGravel;18;0;Create;True;0;0;0;False;0;False;1,1;16,16;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;12;-1599.203,500.2201;Inherit;True;Property;_MaskGrassTexture;MaskGrassTexture;11;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;3ff6f87c551189b47ae882fd77943ed9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;36;-1595.964,1698.865;Inherit;True;Property;_MaskRockTexture;MaskRockTexture;12;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;9268c92b6f62b1d4ab278bfcba329876;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;68;-1458.974,3606.895;Inherit;True;Property;_AlbedoGravel;AlbedoGravel;9;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;baa9dd568cea8384ab7a41a4751ade93;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-1653.724,935.8429;Inherit;False;Property;_ScaleNormalGrass;ScaleNormalGrass;20;0;Create;True;0;0;0;False;0;False;0;0.66;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;135;-216.0655,3962.893;Inherit;False;Property;_TillingTextureParasite1;TillingTextureParasite;0;0;Create;True;0;0;0;False;0;False;1,1;5,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-1648.711,2175.974;Inherit;False;Property;_ScaleNormalRock;ScaleNormalRock;21;0;Create;True;0;0;0;False;0;False;0;0.82;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;55;-1600.21,2931.157;Inherit;True;Property;_MaskDirtTexture;MaskDirtTexture;14;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;7b561dcae4e75b44ba94aa84b224557d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;188;-1136.906,867.2;Inherit;False;ReconstructZNormal;-1;;6;aafcf35eb3822c44a913771e0059d491;0;3;9;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;79;0.4752355,1106.955;Inherit;False;10;MaskDirt;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;129;-1622.391,3404.888;Inherit;False;Property;_ScaleNormalDirt;ScaleNormalDirt;22;0;Create;True;0;0;0;False;0;False;0;0.88;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;136;-37.0665,3757.892;Inherit;True;Property;_TextureParasite1;TextureParasite;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;20c81e09508a5ec4fba65a8abee04320;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;187;-1164.086,2067.775;Inherit;False;ReconstructZNormal;-1;;5;aafcf35eb3822c44a913771e0059d491;0;3;9;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;71;-1604.715,4142.718;Inherit;True;Property;_MaskGravelTexture;MaskGravelTexture;13;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;5ba0118310205464f9b8c2ab072ece29;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;546.9714,5519.801;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;130;-1636.183,4619.258;Inherit;False;Property;_ScaleNormalGravel;ScaleNormalGravel;23;0;Create;True;0;0;0;False;0;False;0;0.67;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;186;-1293.554,3272.531;Inherit;False;ReconstructZNormal;-1;;4;aafcf35eb3822c44a913771e0059d491;0;3;9;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;150;760.7454,5518.737;Inherit;False;AlbedoParasite;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;145;675.3687,3889.3;Inherit;False;ParasiteTexturePattern;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;189;-1225.448,4507.181;Inherit;False;ReconstructZNormal;-1;;7;aafcf35eb3822c44a913771e0059d491;0;3;9;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;159;47.13263,6123.945;Inherit;False;145;ParasiteTexturePattern;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;154;107.4198,6016.683;Inherit;False;150;AlbedoParasite;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;152;253.5127,6274.026;Inherit;False;150;AlbedoParasite;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;191;369.4844,6102.318;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;155;517.5607,6005.275;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;212.9411,286.3007;Inherit;False;Property;_Smoothness;Smoothness;19;0;Create;True;0;0;0;False;0;False;1;0.147;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;146;47.38269,5706.421;Inherit;False;Property;_ParasiteColor1;ParasiteColor;8;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0.6756024,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;160;419.5886,5350.917;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=A9862FE0BC323A432E0BCEC276A9B50765180827